...
def class_to_json(obj):
    ...
    Returns:
        dict: A dictionary representing the object with serializable attributes.

    Note:
        This function assumes that the object has a `__dict__` attribute, which contains
        all the attributes and their values of the object. It directly returns this dictionary,
